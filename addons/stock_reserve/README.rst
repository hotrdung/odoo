...
* Stock Reservation model is prototype inheritance of Stock Move model.
* After "Reserved", the stock move changes to "Assigned", and never "Done" (so stock won't be moved to Reservation location)
* After "Released", the stock move changes to "Canceled", and stock is returned back to the original location
